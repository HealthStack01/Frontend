<>
        ...
        <div className="field">
            <p className="control has-icons-left">
                ...
                <label className="label is-size-7"  >Medical Records Number </label><input className="input is-small" ref={register()} name="mrn" type="text"placeholder="Medical Records Number  " />
                <span className="icon is-small is-left">
                <i className="nop-envelope"></i>
                </span>
            </p>
        ...
        <div className="field">
            <p className="control has-icons-left">
                <label className="label is-size-7" >Next of Kin Phone Number"</label><input className="input is-small" ref={register()}  name="nok_phoneno" type="text"placeholder=" " />
                <span className="icon is-small is-left">
                <i className="nop-clinic-medical"></i>
                </span>
            </p>
        ...
        <div className="field">
            <p className="control has-icons-left">
                ...
                <label className="label is-size-7"  >Next of Kin Relationship"  </label><input className="input is-small" ref={register()} name="nok_relationship" type="text" placeholder="Next of Kin Relationship" />
                <span className="icon is-small is-left">
                <i className="nop-envelope"></i>
                </span>
            </p>
