		...
		<section className='section remPadTop'>
			...
			<div>
				...
				<ModalBox
					...
					header='Create Drug Intolerance'>
				...
				<ModalBox
					...
					header='Drug Intolerance Details'>
				...
				<ModalBox
					...
					header='Modify Drug Intolerance'>
...
export function ClientIntoleranceCreate() {
	...
	const drugData = ['Aspirin', 'Panadol', 'Declofenac'];
...
export function ClientIntoleranceDetail({ showModifyModal }) {
	...
	const drugDataList = ['Aspirin', 'Panadol', 'Declofenac'];
