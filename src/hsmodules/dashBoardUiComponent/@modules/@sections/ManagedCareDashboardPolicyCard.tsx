...
const ManagedCareDashboardPolicyCard: React.FC<ViewCardProps> = ({
	count,
	dataSource,
	isLoading,
}) => {
	...
	const checkBoxTitleArray = ['Total ', 'Total Approved', 'Total Pending '];
...
export default ManagedCareDashboardPolicyCard;
