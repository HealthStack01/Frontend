			...
			<Suspense fallback={<PageLoaderComponent />}>
				<Routes>
					...
					<Route
						...
						<Route
							path='/app/epidemiology'
							element={<EpidemiologyHome />}>
							<Route
								index
						...
						{/**************************MANAGED CARE *************************************** */}
						<Route
							path='/app/managed-care'
							element={<ManagedCareHome />}>
							<Route
								index
						...
						{/**************************Immunization *************************************** */}
						<Route
							path='/app/immunization'
							element={<ImmunizationHome />}>
							<Route
								index
