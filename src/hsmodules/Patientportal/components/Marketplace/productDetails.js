import {Stack,Box,Typography,Grid,CardMedia,CardContent
  ,Rating,CardActions,Drawer,Paper,CardHeader,Avatar,Button,ButtonGroup,Badge,Card} from '@mui/material'
...
export const reviewData=[
  {
    ...
    name:"Danalle",
    time:"4 hours",
    description:"Nexus Pharma’s Gluta-1 Injections are all lyophilized (freeze dried) glutathione."
},
{
  img:"P",
  name:"Paella",
...
export default function ProductDetails({handleGoBack}){
  ...
  const product = products.find(prod => prod.id == productId)
    ...
    return(
     ...
     <GButton onClick={() => navigate(`/app/patient-portal/buy`)}>
            <ArrowBackIcon />
            Go Back
          </GButton> 
      ...
      <Grid container spacing={6}>
        ...
        <Grid
          ...
          sx={{
            ...
            paddingLeft: ['2.5rem !important', '1.5rem !important', '0 !important']
          }}
        >
          <CardContent>
...
<Box pt="2rem">
  ...
  <Typography variant="p" fontSize="14px" fontWeight="normal" color="text.secondary">
{data?.description}
</Typography>
  </Stack>
         </Card>
