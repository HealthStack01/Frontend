...
export default function Appointments() {
  ...
  return (
    <section className="section remPadTop">
      {state.AppointmentModule.show === "list" && <PharmacyList />}
      {state.AppointmentModule.show === "create" && (
        <PharmacyAppointmentCreate />
      )}
      {state.AppointmentModule.show === "detail" && <PharmacyDetail />}
      {state.AppointmentModule.show === "modify" && (
        <PharmacyModify Client={selectedClient} />
      )}
    </section>
  );
}

export function PharmacyAppointmentCreate() {
...
export function PharmacyModify() {
...
export function PharmacySearch({getSearchfacility, clear}) {
  const ClientServ = client.service("client");
  const [facilities, setFacilities] = useState([]);
  // eslint-disable-next-line
