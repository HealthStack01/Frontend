		...
		<>
			<div className='card '>
				<div className='card-header'>
					<p className='card-header-title'>Enter Expense</p>
				</div>
						...
						<div className='field'>
							<p className='control has-icons-left has-icons-right'>
								<input
									...
									name='subclass'
									type='text'
									placeholder='Subclass of Account'
								/>
								<span className='icon is-small is-left'>
									<i className='fas fa-map-signs'></i>
								</span>
						...
						<table className='table is-striped is-narrow is-hoverable is-fullwidth is-scrollable '>
							<thead>
								<tr>
									...
									<th>Name</th>
									<th>
										<abbr title='Group Code'>Group Code</abbr>
									</th>
									<th>
										<abbr title='Account Class'>Class</abbr>
									</th>
									<th>
										<abbr title='Subclass'>Subclass</abbr>
									</th>
									<th>
										<abbr title='Code'>Code</abbr>
									</th>
									<th>
