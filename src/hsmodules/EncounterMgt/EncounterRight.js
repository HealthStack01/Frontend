                ...
                <div className="field-body">
                    <div className="field">
                        <p className="control has-icons-left has-icons-right">
                            <input className="input is-small" ref={register()}  name="Temperature" type="text"  spellCheck="true" placeholder="Temperature" />
                    ...
                    <div className="field">
                        <p className="control has-icons-left has-icons-right">
                        <input className="input is-small" ref={register()}  name="Pulse" type="text"  spellCheck="true" placeholder="Pulse" />
                        <span className="icon is-small is-left">
            ...
            <div className="field is-horizontal">
                ...
                <div className="field">
                    <p className="control has-icons-left">
                        <input className="input is-small" ref={register()} name="Respiratory_rate" type="text"  spellCheck="true" placeholder="Respiratory rate"/>
                        <span className="icon is-small is-left">
                ...
                <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="Random_glucose" type="text"  spellCheck="true" placeholder="Blood Glucose"  />
                        <span className="icon is-small is-left">
            ...
            <div className="field-body">
                <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="Systolic_BP" type="text"  spellCheck="true" placeholder="Systolic BP"  />
                        <span className="icon is-small is-left">
                        <i className="fas fa-envelope"></i>
                        </span>
                    </p>
                ...
                <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="Diastolic_BP" type="text"  spellCheck="true" placeholder="Diastolic_BP"  />
                        <span className="icon is-small is-left">
                        <i className="fas fa-envelope"></i>
                        </span>
                    </p>
             ...
             <div className="field-body">
                <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="SPO2" type="text"  spellCheck="true" placeholder="SPO2"  />
                        <span className="icon is-small is-left">
                        <i className="fas fa-envelope"></i>
                        </span>
                    </p>
                ...
                <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="Pain" type="text"  spellCheck="true" placeholder="Pain"  />
                        <span className="icon is-small is-left">
                        <i className="fas fa-envelope"></i>
                        </span>
                    </p>
        ...
        <div className="field is-horizontal">
            ...
            <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="Height" type="text"  spellCheck="true" placeholder="Height (m)"  />
                        <span className="icon is-small is-left">
                        <i className="fas fa-envelope"></i>
                        </span>
                    </p>
                ...
                <div className="field">
                    <p className="control has-icons-left">
                        ...
                        <input className="input is-small" ref={register()} name="Weight" type="text"  spellCheck="true" placeholder="Weight (Kg)"  />
                        <span className="icon is-small is-left">
                        <i className="fas fa-envelope"></i>
                        </span>
                    </p>
        ...
        <>
            ...
            <div className="field is-horizontal">
                <div className="field-body">
                    <div className="field">
                        <p className="control has-icons-left has-icons-right">
                            <textarea className="textarea is-small" ref={register()}  name="Symptoms" type="text"   placeholder="Symptoms" spellCheck="true"/>
                           {/*  <span className="icon is-small is-left">
                                <i className="fas fa-hospital"></i>
                            </span>   */}                  
                        </p>
            ...
            <div className="field is-horizontal">
                <div className="field-body">
                    <div className="field">
                        ...
                        <textarea className="textarea is-small" ref={register()}  name="Clinical Findings" type="text"  spellCheck="true" placeholder="Clinical Findings" />
                        {/* <span className="icon is-small is-left">
                            <i className="fas fa-map-signs"></i>
                        </span> */}
            ...
            <div className="field is-horizontal">
                ...
                <div className="field">
                    <p className="control has-icons-left">
                        <textarea className="textarea is-small" ref={register()} name="Diagnosis" type="text"  spellCheck="true" placeholder="Diagnosis"/>
                        {/* <span className="icon is-small is-left">
                        <i className=" fas fa-user-md "></i>
                        </span> */}
                    </p>
            ...
            <div className="field-body"> */}       
                <div className="field">
                    <div className="control has-icons-left">
                        ...
                        <textarea className="textarea is-small " ref={register()} name="Plan" type="text"  spellCheck="true" placeholder="Plan"  />
...
const handleChangePart=(e)=>{
    ...
    return (
        <>
            ...
            <div className="field">
                        <p className="control has-icons-left has-icons-right">
                            <input className="input is-small" ref={register()}  name="Investigation" type="text"  spellCheck="true" placeholder="Investigation" />
                            <span className="icon is-small is-left">
                                <i className="fas fa-hospital"></i>
                            </span>                    
                        </p>
            ...
            <div className="field is-horizontal">
                <div className="field-body">
                    <div className="field">
                        <p className="control has-icons-left has-icons-right">
                            <textarea className="textarea is-small" ref={register()}  name="Finding" type="text"  spellCheck="true" placeholder="Findings" />                 
                        </p>
                    </div>
                    </div>
                    </div>
            <div className="field is-horizontal">
                <div className="field-body">
                    <div className="field">
                        <div className="control has-icons-left has-icons-right">
                        <textarea className="textarea is-small" ref={register()}  name="Recommendation" type="text"  spellCheck="true" placeholder="Recommendation" />
                        </div>
                    </div>
                    </div>
                    </div>
...
const handleChangePart=(e)=>{
    ...
    return (
        <>
            ...
            <div className="field">
                        <p className="control has-icons-left has-icons-right">
                            <input className="input is-small" ref={register()}  name="Title" type="text"  spellCheck="true" placeholder="Title" />
                            <span className="icon is-small is-left">
                                <i className="fas fa-hospital"></i>
                            </span>                    
                        </p>
            ...
            <div className="field is-horizontal">
                <div className="field-body">
                    <div className="field">
                        <p className="control has-icons-left has-icons-right">
                            <textarea className="textarea is-small" ref={register()}  name="Documentation" type="text"  spellCheck="true" placeholder="Documentation" />                 
                        </p>
                    </div>
                    </div>
                    </div>
