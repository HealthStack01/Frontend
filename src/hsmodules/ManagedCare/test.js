...
export default function Policy() {
  ...
  return (
    <section className="section remPadTop">
      ...
      {showModal && (
        <ModalBox open={state.ManagedCareModule.show === 'create'}>
          <PolicyCreate showModal={showModal} setShowModal={setShowModal} />
        </ModalBox>
      )}
    </section>
  );
...
export function PolicyCreate({ showModal, setShowModal }) {
