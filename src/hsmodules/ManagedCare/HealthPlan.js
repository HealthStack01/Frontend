...
export function HealthPlanCreate({ showModal, setShowModal }) {
  ...
  const handleServType = async (e, i, c) => {
    ...
    currentPlan.capitation =
      e.target.value === 'Capitation' ? setCap(true) : '';
  ...
  console.log(productItem, serviceUnavailable);
  return (
    <>
      <div
        className="card "
              ...
              >
                <Box sx={{ width: '70vw' }}>
                  ...
                  <Grid container spacing={2} my={2}>
                    ...
                    <Grid item xs={12} sm={12}>
                      <FormsHeaderText text={'Benefitting Plan'} />
...
export function HealthPlanList({ showModal, setShowModal, setSelectedClient }) {
...
export function HealthPlanDetails({ showModal, setShowModal, selectedPlan }) {
