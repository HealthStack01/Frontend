...
const groupPremiumByProvider = premiums => {
...
const ProviderGroupedPremiumnsListComponent = ({premiums, loading}) => {
  ...
  const groupedPremiums = groupPremiumByProvider(premiums);
...
export default ProviderGroupedPremiumnsListComponent;
