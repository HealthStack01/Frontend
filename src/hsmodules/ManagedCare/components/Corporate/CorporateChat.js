...
const CorporateChatComponent = ({closeChat}) => {
  ...
  const getChatMessages = useCallback(async () => {
    const id = state.ManagedCareCorporate.selectedCorporate._id;
  ...
  }, [state.ManagedCareCorporate.selectedCorporate]);
  ...
  const sendNewChatMessage = async () => {
    ...
    const currentFac = state.ManagedCareCorporate.selectedCorporate;
...
export default CorporateChatComponent;
