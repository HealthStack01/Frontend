      ...
      <div className="card ">
        ...
        <div className="card-content vscrollable remPad1">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="field">
              {/*    <p className="control ">
                            <input className="input is-small"   {...register} name="Marital_Status" type="text" placeholder="Marital Status" />
            ...
            <div className="field">
              <label className=" is-small">
                <input type="checkbox" name="Not_Taking_Meds" {...register} />{" "}
            ...
            <div className="field">
              <label className=" is-small">
                <input type="checkbox" name="NKDA" {...register} /> NKDA
              </label>
            </div>
