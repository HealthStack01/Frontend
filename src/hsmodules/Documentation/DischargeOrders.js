    ...
    return(
        <section className= "section remPadTop">
           {/*  <div className="level">
            ...
            <div className="column is-6 ">
                {(state.EndEncounterModule.selectedEndEncounter==='Discharge')&&<DischargeOrdersCreate />}
        ...
        <>
            ...
            <div className="card-header">
                <p className="card-header-title">
                    Create Discharge Orders for {state.ClientModule.selectedClient.firstname+ " "+state.ClientModule.selectedClient.middlename+" "+state.ClientModule.selectedClient.lastname} on {state.ClientModule.selectedClient.ward + " ward, "} bed: {state.ClientModule.selectedClient.bed } 
                </p>
            </div>
    ...
    return(
            ...
            <>  
                <div className="level">
                   ...
                   {!standalone && (<><div className="level-item"> <span className="is-size-6 has-text-weight-medium">List of Discharge Orders </span></div>
                ...
                <div className="table-container pullup ">
                                <table className="table is-striped is-narrow is-hoverable is-fullwidth is-scrollable ">
                                    <thead>
                                        ...
                                        <th><abbr title="Order">Order</abbr></th>
                                        <th>Fulfilled</th>
