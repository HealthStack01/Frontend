        ...
        <div className="card-content vscrollable">
          <div className="field-body mt-3">
            <div className="field is-flex">
              <label className="label is-small mr-2">Name</label>
              <p className="control is-expanded">
                <input ref={register} name="name" className="input is-small is-inline-block" type="text" />
              </p>
            </div>
          </div>
          ...
          <div className="columns mt-3 is-flex-wrap-wrap">
            ...
            <div className="column">
              <div className="field-body">
                <div className="field is-flex">
                  <label className="label is-small mr-2">Age</label>
                  <p className="control is-expanded">
            ...
            <div className="column">
              <div className="field-body">
                <div className="field is-flex">
                  <label className="label is-small mr-2">Sex</label>
                  <p className="control is-expanded">
            ...
            <div className="column">
              <div className="field-body">
                <div className="field is-flex">
                  <label className="label is-small mr-2">Date</label>
          ...
          <div className="columns mt-3 is-flex-wrap-wrap">
            <div className='is-flex'>           
              <div className="column is-half">
                <div className="field-body">
                  <div className="field is-flex">
                    <label className="label is-small mr-2">Specimen</label>
                    <p className="control is-expanded">
              ...
              <div className="column is-half">
                <div className="field-body">
                  <div className="field is-flex">
                    <label className="label is-small mr-2">Provisional Diagnosis</label>
                    <p className="control is-expanded">
            ...
            <div className="column">
              <div className="field-body">
                <div className="field is-flex">
                  <label className="label is-small mr-2">Bill To</label>
          ...
          <div className="columns mt-3">
            <div className="column">
              <div className="field-body">
                <div className="field is-flex">
                  <label className="label is-small mr-2">Patient</label>
                  <p className="control is-expanded">
            ...
            <div className="column">
              <div className="field-body">
                <div className="field is-flex">
                  <label className="label is-small mr-2">Dr</label>
                  <div className="control">
          ...
          <label className="label is-small" onClick={handleHaem}>HEAMATOLOGY</label>
          {
            isHeam && (
              <div>
                <div className="columns mt-3 is-flex-wrap-wrap">
          ...
          <label className="label is-small" onClick={handleSerology}>SEROLOGY</label>
          {
            isSero && (
              <>
                <div className="columns mt-3 is-flex-wrap-wrap">
          ...
          <label className="label is-small" onClick={handleBioChem}>BIOCHEMISTRY</label>
          {
            isBio && (
              <>
                  <div className="columns mt-3 is-flex-wrap-wrap">
              ...
              <label className="label is-small" onClick={handleMicro}>MICROBIOLOGY</label>
              {
                isMicro && (
                  <div className="field">
          ...
          <label className="label is-small" onClick={handleUrine}>URINE</label>
          {
             isUrine && (
                <>
          ...
          <label className="label is-small" onClick={handleUrinalysis}>URINALYSIS</label>
          {
            isUrinalysis && (
                <>
                <div className="columns">
          ...
          <label className="label is-small" onClick={handleStool}>STOOL</label>
          {
              isStool && (
                <>
                <div className="field">
          ...
          <label className="label is-small"onClick={handleHvs}>HVS CULTURE</label>
          {
            isHvs && (
              <>
