        ...
        <div className="card-content vscrollable">
          ...
          <div className="field">
            ...
            <label class="checkbox me-3">
              <input {...register} name="ivUrography" type="checkbox" />
            ...
            <label class="checkbox me-3">
              <input {...register} name="cytourethrography" type="checkbox" />
            ...
            <label class="checkbox me-3">
              <input {...register} name="skeletalSurneyAdult" type="checkbox" />
              <span className="ms-2 is-small">Skeletal Surney - Adult</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="mammography" type="checkbox" />
              <span className="ms-2 is-small">Mammography</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="wellWomanPackage" type="checkbox" />
              <span className="ms-2 is-small">
          ...
          <div className="field">
            <label class="checkbox me-3">
              <input {...register} name="ctBrain" type="checkbox" />
              <span className="ms-2 is-small">CT Brain</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctFacial" type="checkbox" />
              <span className="ms-2 is-small">CT Facial</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctSinuses" type="checkbox" />
            ...
            <label class="checkbox me-3">
              <input {...register} name="ctBrainOrPituitary" type="checkbox" />
            ...
            <label class="checkbox me-3">
              <input {...register} name="ctNeck" type="checkbox" />
              <span className="ms-2 is-small">CT Neck (Thyroid Gland)</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctChest" type="checkbox" />
              <span className="ms-2 is-small">CT Chest</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctAbdomen" type="checkbox" />
              <span className="ms-2 is-small">CT Abdomen</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctPelvic" type="checkbox" />
              <span className="ms-2 is-small">CT Pelvic</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctAbdomenAndPelvic" type="checkbox" />
              <span className="ms-2 is-small">CT Abdomen & Pelvic</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctCervicalSpine" type="checkbox" />
              <span className="ms-2 is-small">CT Cervical Spine</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctThoracicSpine" type="checkbox" />
              <span className="ms-2 is-small">CT Thoracic Spine</span>
            </label>
            {/* <label class="checkbox me-3">
              <input {...register} name="ctPelvic2" type="checkbox" />
              <span className="ms-2 is-small">CT Pelvic</span>
            </label> */}
            <label class="checkbox me-3">
              <input {...register} name="ctLumboSpine" type="checkbox" />
              <span className="ms-2 is-small">CT Lumbosacral Spine</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ctTwoSpinalRegion" type="checkbox" />
          ...
          <div className="field">
            <label class="checkbox me-3">
              <input {...register} name="skullAllView" type="checkbox" />
              <span className="ms-2 is-small">Skull - All View</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="skullApAndLateral" type="checkbox" />
              <span className="ms-2 is-small">Skull - AP & Lateral</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="sinuses" type="checkbox" />
              <span className="ms-2 is-small">Sinuses</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="mastoids" type="checkbox" />
            ...
            <label class="checkbox me-3">
              <input {...register} name="dorsalSpine" type="checkbox" />
              <span className="ms-2 is-small">
                Dorsal Spine (Thraoracic Spine)
              </span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="thoracolumnerSpine" type="checkbox" />
              <span className="ms-2 is-small">Thoracolumner Spine</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="lumbosacralSpineAL" type="checkbox" />
              <span className="ms-2 is-small">
                Lumbosacral Spine (AP & Lateral)
              </span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="oneOrBothHip" type="checkbox" />
              <span className="ms-2 is-small">One Hip / Both Hip</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="chestAL" type="checkbox" />
              <span className="ms-2 is-small">Chest (Ap & Lateral)</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="chestApOnly" type="checkbox" />
              <span className="ms-2 is-small">Chest (Ap Only)</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="abdomenSupineErect" type="checkbox" />
              <span className="ms-2 is-small">Abdomen (Supine & Erect)</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="abdomenOneView" type="checkbox" />
              <span className="ms-2 is-small">Abdomen (One View)</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="shoulderJoint" type="checkbox" />
            ...
            <label class="checkbox me-3">
              <input {...register} name="wristJoint" type="checkbox" />
              <span className="ms-2 is-small">Wrist Joint</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="hand" type="checkbox" />
              <span className="ms-2 is-small">Hand</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="femur" type="checkbox" />
              <span className="ms-2 is-small">Thigh - Femur</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="knee" type="checkbox" />
              <span className="ms-2 is-small">Knee Joint</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="leg" type="checkbox" />
              <span className="ms-2 is-small">Leg - Tibia & Fibular</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="ankleJoint" type="checkbox" />
              <span className="ms-2 is-small">Ankle Joint</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="foot" type="checkbox" />
              <span className="ms-2 is-small">Foot</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="postNasalSpace" type="checkbox" />
              <span className="ms-2 is-small">Post - Nasal Space</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="risserTest" type="checkbox" />
              <span className="ms-2 is-small">Risser Test</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="pelvic" type="checkbox" />
              <span className="ms-2 is-small">Pelvic</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="mandible" type="checkbox" />
              <span className="ms-2 is-small">Mandible</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="orbit" type="checkbox" />
              <span className="ms-2 is-small">Orbit</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="neckSoftTissue" type="checkbox" />
              <span className="ms-2 is-small">Neck (Soft Tissue)</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="sacrum" type="checkbox" />
              <span className="ms-2 is-small">Sacrum / Coccyx</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="clavicle" type="checkbox" />
              <span className="ms-2 is-small">Clavicle</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="patellaViews" type="checkbox" />
              <span className="ms-2 is-small">Patella Views</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="scapula" type="checkbox" />
              <span className="ms-2 is-small">Scapula</span>
            </label>
            <label class="checkbox me-3">
              <input {...register} name="thoracicInlet" type="checkbox" />
