      ...
      <div className="card">
        ...
        <div className="card-content vscrollable">
          ...
          <label class="checkbox me-3">
            <input {...register} name="single" type="checkbox" />
            <span className="ms-2 is-small">Single</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="married" type="checkbox" />
            <span className="ms-2 is-small">Married</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="others" type="checkbox" />
          ...
          <div className="field w-100 mt-3">
            <div className="control">
              <label className="radio">
                <input {...register} type="radio" name="allegies" />
          ...
          <label class="checkbox me-3">
            <input {...register} name="chestPain" type="checkbox" />
            <span className="ms-2 is-small">Chest Pain</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="hrtDisease" type="checkbox" />
            <span className="ms-2 is-small">Heart Disease</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="migranes" type="checkbox" />
            <span className="ms-2 is-small">Migranes</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="infection" type="checkbox" />
            <span className="ms-2 is-small">Infection</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="cancer1" type="checkbox" />
            <span className="ms-2 is-small">Cancer</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="insomnia" type="checkbox" />
          ...
          <div className="field w-100 mt-3">
            ...
            <div className="control">
              <label className="radio">
                <input {...register} type="radio" name="drinkAlcoholYes" />
                <span className="ms-2">Yes</span>
              </label>
              <label className="radio">
                <input {...register} type="radio" name="drinkAlcoholNo" />
                <span className="ms-2">No</span>
              </label>
            </div>
          </div>
          <div className="field w-100 mt-3">
            ...
            <div className="control">
              <label className="radio">
                <input {...register} type="radio" name="tobaccoYes" />
                <span className="ms-2">Yes</span>
              </label>
              <label className="radio">
                <input {...register} type="radio" name="tobaccoNo" />
                <span className="ms-2">No</span>
              </label>
            </div>
          </div>
          ...
          <label class="checkbox me-3">
            <input {...register} name="diabetic" type="checkbox" />
            <span className="ms-2 is-small">Diabetic</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="hypertensive" type="checkbox" />
            <span className="ms-2 is-small">Hypertensive</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="familyCancer" type="checkbox" />
            <span className="ms-2 is-small">Cancer</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="arthritis" type="checkbox" />
            <span className="ms-2 is-small">Arthritis</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="hrtProblems" type="checkbox" />
            <span className="ms-2 is-small">Heart Problems</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="stroke" type="checkbox" />
          ...
          <label class="checkbox me-3">
            <input {...register} name="surgeryYes" type="checkbox" />
            <span className="ms-2 is-small">Yes</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="surgeryNo" type="checkbox" />
          ...
          <label class="checkbox me-3">
            <input {...register} name="privatePatient" type="checkbox" />
            <span className="ms-2 is-small">Private Patient?</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="corporatePatient" type="checkbox" />
            <span className="ms-2 is-small">Corporate Patient?</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="insurance" type="checkbox" />
          ...
          <label class="checkbox me-3">
            <input {...register} name="authLetterYes" type="checkbox" />
            <span className="ms-2 is-small">Yes</span>
          </label>
          <label class="checkbox me-3">
            <input {...register} name="authLetterNo" type="checkbox" />
            <span className="ms-2 is-small">No</span>
          </label>
