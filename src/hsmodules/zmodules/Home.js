...
function NavBar({url}) {
  ...
  const handleFacilityClick = () => {
    //need to implement changing facility
  ...
  return (
    <div>
      <nav
        className="navbar is-small minHt has-background-info"
        role="navigation"
        aria-label="main navigation"
      >
        <div className="navbar-brand minHt">
          <div
            className="navbar-item is-size-5 minHt"
          ...
          <div>
            ...
            <button className="button is-small " onClick={() => handlelisten()}>
              Start
            </button>
            <button
            ...
            <button className="button is-small " onClick={resetTranscript}>
              Reset
            </button>
        ...
        <div
          className={`navbar-menu minHt  has-background-info ${
            showmenu ? "is-active" : ""
          }`}
          ...
          <div className="navbar-end">
            <div className="navbar-item has-dropdown is-hoverable  has-background-info">
              ...
              <div className="navbar-dropdown bckcolor">
                ...
                {(user.currentEmployee?.roles.includes("Client") ||
                  user.currentEmployee?.roles.length === 0) && (
                  <div className="navbar-item" onClick={handleBurger}>
                    <NavLink to={`${url}/client`}>Clients</NavLink>
                  </div>
                )}
                {(user.currentEmployee?.roles.includes("Clinic") ||
                  user.currentEmployee?.roles.length === 0) && (
                  <div className="navbar-item" onClick={handleBurger}>
                    <NavLink to={`${url}/clinic`}>Clinic</NavLink>
                  </div>
                )}
                {(user.currentEmployee?.roles.includes("Ward") ||
                  user.stacker) && (
                  <div className="navbar-item" onClick={handleBurger}>
                    <NavLink to={`${url}/ward`}>Ward</NavLink>
                  </div>
                )}
                {(user.currentEmployee?.roles.includes("Pharmacy") ||
                  user.currentEmployee?.roles.length === 0 ||
                  user.stacker) && (
                  <div className="navbar-item" onClick={handleBurger}>
                ...
                {(user.currentEmployee?.roles.includes("Inventory") ||
                  user.currentEmployee?.roles.length === 0 ||
                  user.stacker) && (
                  <div className="navbar-item" onClick={handleBurger}>
                ...
                {(user.currentEmployee?.roles.includes("Laboratory") ||
                  user.currentEmployee?.roles.length === 0) && (
                  <div className="navbar-item" onClick={handleBurger}>
                    <NavLink to={`${url}/labs`}>Laboratory</NavLink>
                  </div>
                )}
                {(user.currentEmployee?.roles.includes("Radiology") ||
                  user.currentEmployee?.roles.length === 0) && (
                  <div className="navbar-item" onClick={handleBurger}>
                    <NavLink to={`${url}/radiology`}>Radiology</NavLink>
                  </div>
                )}
                {(user.currentEmployee?.roles.includes("Theatre") ||
                  user.currentEmployee?.roles.length === 0 ||
                  user.stacker) && (
                  <div className="navbar-item" onClick={handleBurger}>
                ...
                {(user.currentEmployee?.roles.includes("Finance") ||
                  user.stacker) && (
                  <div className="navbar-item" onClick={handleBurger}>
                ...
                {(user.currentEmployee?.roles.includes("Epidemiology") ||
                  user.currentEmployee?.roles.length === 0) && (
                  <div className="navbar-item" onClick={handleBurger}>
