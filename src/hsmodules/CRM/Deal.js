...
export default function Deal() {
  ...
  return (
    <section className="section remPadTop">
      <DealList showModal={showModal} setShowModal={setShowModal} />
    </section>
  );
}
...
export function DealList({ showModal, setShowModal }) {
  ...
  const dummyData = [
    {
      company_name: "Sulaiman Olaniran",
      phone_no: "Family",
      amount: "500,000:00",
      duration: "CEO",
      status: "Active",
    ...
    {
      company_name: "Albert Sulaiman Olaniran",
      phone_no: "Family",
      amount: "500,000:00",
      duration: "CEO",
      status: "Active",
