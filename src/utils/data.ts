...
export const organizationTypeOptions: string[] = ['Hospital', 'Research Institute'];
export const organizationOptions: string[] = ['Private', 'Public', 'Government'];

export const countriesOptions: string[] = ['Nigeria', 'France', 'England', 'Cameron'];
export const statesOptions: string[] = ['Lagos', 'Oyo', 'Ogun', 'Paris'];
export const departmentOptions: string[] = ['Frontdesk', 'Accpunting', 'Clinic', 'Pharmacy'];
export const unitsOptions: string[] = ['Unit 1', 'Unit 1', 'Unit 1', 'Unit 1'];
export const bandTypeOptions: string[] = ['Band 1', 'Band 2', 'Band 3', 'Band 4'];
...
export const localGovt = ['Ibadan S/W', 'Lagos Central', 'Abuja Central', 'Kaduna Central'];
export const townCity = ['Ikeja', 'Epe', 'Ofa', 'Ibadan'];
export const nextOfKin = ['Wale Romi', 'Blond Games', 'Williams Tosin', 'Wale Romi'];
