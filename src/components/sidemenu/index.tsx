...
export const menuItems = [
  {
    ...
    subMenus: [{ name: "Dashboard", to: "/app/dashboard" }],
  },
  {
    name: "Client",
    exact: true,
  ...
  },
  {
    ...
    subMenus: [
      ...
      { name: "Dashboard", to: "/app/managedCare/dashboard" },
    ],
  },
  {
    name: "Finance",
  ...
  //francis  added ward and inventory
  {
    name: "Ward",
    exact: true,
    to: "/app/ward",
    iconClassName: "bi bi-bezier",
    subMenus: [{ name: "Dashboard", to: "/app/ward/dashboard" }],
  },
  {
    name: "Inventory",
    exact: true,
    to: "/app/Inventory",
    iconClassName: "bi bi-bezier",
    subMenus: [{ name: "Dashboard", to: "/app/inventory/dashboard" }],
  },
  {
    name: "Admin",
    exact: true,
