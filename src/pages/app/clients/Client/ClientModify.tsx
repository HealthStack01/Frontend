...
const ClientModify: React.FC<Props> = ({ cancelEditClicked, row: client, backClick, onSubmit, handleDelete }) => {
    ...
    <PageWrapper>
      <GrayWrapper>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <BottomWrapper>
            <Button label="Delete Client" background="#FFE9E9" color="#ED0423" onClick={handleDelete} />
